'use client';
// components/public/CatalogPageClient.jsx — Catálogo público (Client Component)
// Extraído de app/page.jsx para permitir que app/page.jsx sea un Server Component
// con export const revalidate = 60 (ISR, Sprint 5).
//
// Toda la lógica interactiva del catálogo vive aquí:
//   hero con stats, filtros (año/técnica/tags/búsqueda), grid, favoritos,
