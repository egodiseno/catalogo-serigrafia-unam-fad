...
const NAV_ITEMS = [
  ...
  { section: 'registros-pendientes', label: 'Registros', href: '/admin/registros-pendientes', Icon: UserCheck, roles: ['admin', 'super_editor'] },
  { section: 'control-registro', label: 'Control Registro', href: '/admin/control-registro', Icon: ToggleRight, roles: ['admin', 'super_editor'] },
