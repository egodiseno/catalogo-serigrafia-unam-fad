...
| `catalogo.html` | Catálogo general | Implementada | Grid de obras, búsqueda, filtros, chips y botón `Cargar más obras`. |
...
| Ruta | Uso |
|---|---|
| `catalogo.html?year=2024` | Catálogo filtrado por año. |
| `catalogo.html?year=2023` | Catálogo filtrado por año. |
| `catalogo.html?year=2022` | Catálogo filtrado por año. |
| `catalogo.html?year=2021` | Catálogo filtrado por año. |
| `catalogo.html?technique=Serigraf%C3%ADa%20experimental` | Catálogo filtrado por técnica. |
| `catalogo.html?series=Archivo%20gr%C3%A1fico` | Catálogo filtrado por serie. |
